...
class ResultCode :
 ...
 public:
  ...
  // bytes ermsg = 2;
  void clear_ermsg();
  const std::string& ermsg() const;
  void set_ermsg(const std::string& value);
  void set_ermsg(std::string&& value);
  void set_ermsg(const char* value);
  void set_ermsg(const void* value, size_t size);
  std::string* mutable_ermsg();
  std::string* release_ermsg();
  void set_allocated_ermsg(std::string* ermsg);
  private:
  const std::string& _internal_ermsg() const;
  void _internal_set_ermsg(const std::string& value);
  std::string* _internal_mutable_ermsg();
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr ermsg_;
...
// bytes ermsg = 2;
inline void ResultCode::clear_ermsg() {
  ermsg_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& ResultCode::ermsg() const {
  // @@protoc_insertion_point(field_get:fixbug.ResultCode.ermsg)
  return _internal_ermsg();
}
inline void ResultCode::set_ermsg(const std::string& value) {
  _internal_set_ermsg(value);
  // @@protoc_insertion_point(field_set:fixbug.ResultCode.ermsg)
}
inline std::string* ResultCode::mutable_ermsg() {
  // @@protoc_insertion_point(field_mutable:fixbug.ResultCode.ermsg)
  return _internal_mutable_ermsg();
}
inline const std::string& ResultCode::_internal_ermsg() const {
  return ermsg_.GetNoArena();
}
inline void ResultCode::_internal_set_ermsg(const std::string& value) {
  
  ermsg_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void ResultCode::set_ermsg(std::string&& value) {
  
  ermsg_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:fixbug.ResultCode.ermsg)
}
inline void ResultCode::set_ermsg(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  ermsg_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:fixbug.ResultCode.ermsg)
}
inline void ResultCode::set_ermsg(const void* value, size_t size) {
  
  ermsg_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:fixbug.ResultCode.ermsg)
}
inline std::string* ResultCode::_internal_mutable_ermsg() {
  
  return ermsg_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* ResultCode::release_ermsg() {
  // @@protoc_insertion_point(field_release:fixbug.ResultCode.ermsg)
  
  return ermsg_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void ResultCode::set_allocated_ermsg(std::string* ermsg) {
  if (ermsg != nullptr) {
    
  } else {
    
  }
  ermsg_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ermsg);
  // @@protoc_insertion_point(field_set_allocated:fixbug.ResultCode.ermsg)
}
